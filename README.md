...
| MiniMax                | Reads a local MiniMax/Pi key or OAuth access token and the first-party Token Plan or balance response. Named `model_remains` rows become model-scoped windows labeled from their reported duration; absent numeric observations remain absent, and no account-wide bound is inferred.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
